...
ipcMain.handle("print:receipt", (_e, mmWidth) => {
  ...
  mainWindow.webContents.print(
    {
      // silent:false — เคยลองเปลี่ยนเป็น silent:true (พิมพ์ตรงไม่ผ่านกล่องโต้ตอบ) เพื่อแก้ปัญหา
      // "จำนวนชุด" ของกล่องโต้ตอบไปทับค่า copies ที่โปรแกรมส่ง แต่กลับทำให้เครื่องพิมพ์ใบเสร็จบางรุ่น
      // ปริ้นออกมาเป็นกระดาษเปล่า (ไดรเวอร์เครื่องพิมพ์ใบเสร็จหลายรุ่นรองรับเฉพาะขนาดกระดาษที่ตั้งไว้ใน
      // ตัวไดรเวอร์เอง พอสั่งพิมพ์แบบไม่ผ่านกล่องโต้ตอบพร้อมกำหนดขนาดกระดาษเองแล้วไดรเวอร์รับค่าไม่ได้
      // เลยพิมพ์ออกมาว่างเปล่า) — เปลี่ยนกลับเป็น silent:false เพื่อให้พิมพ์ใบเสร็จได้จริงก่อน
      silent: false,
